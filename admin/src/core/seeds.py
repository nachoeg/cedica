...
def run():
    ...
    cobro1 = cobros.crear_cobro(medio_de_pago='efectivo', monto=400, observaciones="Nada para agregar")
    cobro2 = cobros.crear_cobro(medio_de_pago='credito', monto=500, observaciones="Queda al día")